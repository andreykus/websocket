...
public class FileServlet extends HttpServlet {
    ...
    private static final long DEFAULT_EXPIRE_TIME = 10L; // 10 ms.
    private static final String MULTIPART_BOUNDARY = "MULTIPART_BYTERANGES";
    private static final String STATIC_CONTENT_FILES_PATH_PARAM_NAME = "STATICCONTENTPATH";
    ...
    public void init() throws ServletException {
        ...
        this.basePath = "";//Config.getConfig(this.getModuleName()).getParam(STATIC_CONTENT_FILES_PATH_PARAM_NAME, "");
